/**
 * Open Power Telemetry Proxy — Cloudflare Pages Function
 *
 ...
 *   HF_DATASET_REPO  — Target dataset repo (e.g. "pliny-the-prompter/open-power")
 *
...
// Define dummy PagesFunction type for local tsconfig since this runs in CF Pages
type PagesFunction<T = unknown> = (context: any) => Promise<Response> | Response
...
const ALLOWED_FIELDS = new Set<string>([
  ...
  // Open Power CLASSIC race fields
  'winner_combo',
  'combos_attempted',
  'combos_succeeded',
  'combos_failed',
